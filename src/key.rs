...
impl Key {
    ...
    pub const C_MAJOR: Key = Key::new(PitchClass::C, Mode::Major);
    pub const G_MAJOR: Key = Key::new(PitchClass::G, Mode::Major);
    pub const F_MAJOR: Key = Key::new(PitchClass::F, Mode::Major);
    pub const D_MAJOR: Key = Key::new(PitchClass::D, Mode::Major);
